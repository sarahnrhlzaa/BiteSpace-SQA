...
<style>
    ...
    .form-card-title {
        font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 700; font-size: 15px; color: var(--dark);
    }
...
<div class="form-card">
    <div class="form-card-head">
        <i class="bi bi-ticket-perforated-fill" style="color:#FFD166; font-size:18px;"></i>
        <div class="form-card-title">Tambah Promo Baru</div>
    </div>
    <div class="form-card-body">
        ...
        <form action="<?= base_url('promo/store') ?>" method="POST">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    <label class="form-label">Kode Promo <span class="req">*</span> <span class="hint">— otomatis uppercase</span></label>
                    <input type="text" name="kode_promo" class="form-control-bs"
                           placeholder="cth: LEBARAN26"
                           value="<?= strtoupper(old('kode_promo')) ?>"
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="nama_promo" class="form-control-bs"
                           ...
                           value="<?= old('nama_promo') ?>" maxlength="100" required>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" class="form-control-bs" rows="2"
                          placeholder="Jelaskan syarat dan ketentuan promo..." maxlength="500"><?= old('deskripsi') ?></textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="tipe-selector">
                    <label class="tipe-btn <?= old('tipe_diskon') !== 'nominal' ? 'selected-percent' : '' ?>" id="btnPercent" onclick="setTipe('percent')">
                        <input type="radio" name="tipe_diskon" value="percent" <?= old('tipe_diskon') !== 'nominal' ? 'checked' : '' ?>>
                        <div class="tipe-icon">%</div>
                        <div>Persen</div>
                        <div style="font-size:11px; color:inherit; opacity:0.7; margin-top:2px;">Diskon % dari total</div>
                    </label>
                    <label class="tipe-btn <?= old('tipe_diskon') === 'nominal' ? 'selected-nominal' : '' ?>" id="btnNominal" onclick="setTipe('nominal')">
                        <input type="radio" name="tipe_diskon" value="nominal" <?= old('tipe_diskon') === 'nominal' ? 'checked' : '' ?>>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    ...
                    <div class="input-group-bs">
                        <span class="input-prefix" id="nilaiPrefix">%</span>
                        <input type="number" name="nilai_diskon" id="nilaiInput"
                               class="form-control-bs input-with-prefix-wide"
                               placeholder="cth: 20" min="0.01" step="0.01"
                               value="<?= old('nilai_diskon') ?>" required>
                    </div>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Maks Diskon <span class="hint" id="maksHint">— untuk tipe persen</span></label>
                    <div class="input-group-bs">
                        <span class="input-prefix">Rp</span>
                        <input type="number" name="maks_diskon" id="maksInput"
                               class="form-control-bs input-with-prefix"
                               placeholder="cth: 50000" min="0" step="1"
                               value="<?= old('maks_diskon') ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group-bs">
                        ...
                        <input type="number" name="min_transaksi"
                               class="form-control-bs input-with-prefix"
                               placeholder="cth: 50000" min="0" step="1"
                               value="<?= old('min_transaksi') ?? 0 ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <div style="display:flex; align-items:center; gap:12px; height:42px;">
                        ...
                        <span style="font-size:13px; color:var(--dark);" id="statusLabel">Aktif</span>
                    </div>
                </div>
            </div>
            ...
            <div style="display:flex; gap:10px; padding-top:8px;">
                ...
                <button type="submit" class="btn-submit-bs">
                    <i class="bi bi-check-lg"></i> Simpan Promo
                </button>
            </div>
        </form>
    </div>
...
function setTipe(tipe) {
    ...
    if (tipe === 'percent') {
        ...
        maksInput.placeholder = 'cth: 50000';
...
// Init
setTipe('<?= old('tipe_diskon', 'percent') ?>');
